...
namespace seraphim {
	...
	private:
		...
		CefRefPtr<ResponsetHandler>  mResourceHandelr;
	public:
	...
	public:
		...
		CefRefPtr<CefResponseFilter> GetResponseFilter(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, CefRefPtr<CefRequest> request, CefRefPtr<CefResponse> response);
	};
};